package autopilot.driver;

import static autopilot.driver.util.ByteConversor.extractShort;
import static autopilot.driver.util.ByteConversor.extractSignedInt;
import static autopilot.driver.util.ByteConversor.extractSignedShort;
...
import autopilot.communication.serial.SerialCommunication;
import autopilot.driver.util.crc16.CRC16JavaImp;
import autopilot.driver.util.crc16.ICRC16;
import autopilot.driver.util.AsctecPackage;


import autopilot.driver.robotcontrol.api.IRobotControl;
import autopilot.driver.robotcontrol.api.IStateSensor;
...
public class AsctecDriver implements IRobotControl, IStateSensor, ICRC16 {
	...
	private ICommunication communicator;
	private ICRC16 crc16Helper;
	...
	public double[] senseIMU() {
		...
		// pressure
		double pressure = extractSignedInt(p.getDataBytes(), 0);
	...
	public void velocityControl(double x, double y, double z, double angX,
		...
		// normalized.
		thrust *= 100 / Math.sqrt(6);

		System.out.println("t:\t" + thrust + "\npitch=\t" + pitch + "\nroll=\t"
				+ roll + "\nyaw=\t" + yaw);
