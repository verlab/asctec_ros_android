...
import asctec_hl_comm.MavCtrlSrvRequest;
import asctec_hl_comm.MavCtrlSrvResponse;
import asctec_hl_comm.mav_ctrl;
import asctec_hl_comm.mav_ctrl_motorsRequest;
import asctec_hl_comm.mav_ctrl_motorsResponse;
...
public class AsctecControlNode extends AbstractNodeMain {
    ...
    public void onStart(final ConnectedNode connectedNode) {
        ...
        // cmd_vel
        Subscriber<Twist> suscriptor = connectedNode
                .newSubscriber("cmd_vel", geometry_msgs.Twist._TYPE);

        suscriptor
                .addMessageListener(new MessageListener<Twist>() {
